  ...
  return (
    <div className="w-full pt-5 pb-10 grid grid-cols-2">
      ...
      <div className="flex relative justify-center col">
        <img
          src={appleFull}
          className="h-auto -scale-x-100 md:w-3/4 lg:w-3/6 absolute object-contain"
          alt="apple"
        ></img>
        <img
          src={melonCut}
          className="h-auto md:w-3/4 lg:w-3/6 absolute translate-y-5 translate-x-32 md:translate-x-40 object-contain"
          alt="watermelon"
        ></img>
      </div>
    </div>
